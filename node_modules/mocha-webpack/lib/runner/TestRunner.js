...
var TestRunner = function (_EventEmitter) {
  ...
  function TestRunner(entries, includes, options) {
    ...
    _this.tmpPath = _path2.default.join(_this.options.cwd, '.tmp', 'mocha-webpack', Date.now().toString());
  ...
  (0, _createClass3.default)(TestRunner, [{
    ...
    value: function run() {
      return new Promise(function ($return, $error) {
        ...
        return this.createWebpackConfig().then(function ($await_5) {
          _ref = $await_5, config = _ref.webpackConfig;
    ...
    value: function watch() {
      return new Promise(function ($return, $error) {
        var _this3, _ref2, config, entryConfig, mochaRunner, stats, compilationScheduler, uncaughtExceptionListener, runMocha, compiler, watchCompiler, watchOptions, watcher, restartWebpackBuild, fileDeletedOrAdded;

        _this3 = this;
        return this.createWebpackConfig().then(function ($await_7) {
          _ref2 = $await_7, config = _ref2.webpackConfig, entryConfig = _ref2.entryConfig;
    ...
    value: function createWebpackConfig() {
      return new Promise(function ($return, $error) {
        var _this4, webpackConfig, files, entryConfig, outputFileName, outputPath, plugins, userLoaders, config;
        ...
        return (0, _glob.glob)(this.entries, {
          ...
          userLoaders = (0, _get3.default)(webpackConfig, 'module.rules', (0, _get3.default)(webpackConfig, 'module.loaders', []));
          userLoaders.unshift({
            test: entryPath,
            use: [{
          ...
          config = (0, _extends4.default)({}, webpackConfig, {
            entry: entryPath,
            module: (0, _extends4.default)({}, webpackConfig.module, (0, _defineProperty3.default)({}, (0, _has3.default)(webpackConfig, 'module.loaders') ? 'loaders' : 'rules', userLoaders)),
            output: (0, _extends4.default)({}, webpackConfig.output, {
